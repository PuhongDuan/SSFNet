...
if __name__ == '__main__':  
    ...
    for data in data_list:
        ...
        img_save_path = img_save_dir + '/' + img_pth.split('\\')[4]
...
#             break        
        ...
        # img
        if pred != label:
            img_save_path = img_save_path.replace('.jpg', '_false_{}.jpg'.format(label2cls_list[str(pred)]))  \
                                         .replace('attvisual_image/', 'attvisual_image/false/')
